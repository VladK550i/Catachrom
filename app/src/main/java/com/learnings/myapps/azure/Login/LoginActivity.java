package com.learnings.myapps.azure.login;
...
import com.learnings.myapps.azure.registration.RegistrationActivity;
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                Toast.makeText(getBaseContext(), "There was an error during the connection", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
            return null;
        }
